...
//    }
    ...
    public void generateReport1() {
        ...
        for (ArrayList<Bookings> list : allLessonsBookingsAL) {
            ...
            JLabel lessonLabel = new JLabel("Lesson ID: " + list.get(0).getLesson().getId() + "     " + list.get(0).getLesson().getName() + "     " + getDateTimeShortString(list.get(0).getLesson().getDateTime()) + "     " + list.get(0).getLesson().getCoach().getFullName());
...
//            System.out.println("+++++++++" + list);
            ...
            JLabel coachLabel = new JLabel("Coach ID: " + list.get(0).getCoach().getId() + "     " + list.get(0).getCoach().getFullName() + "     " + getOfficeHourShortString(list.get(0).getCoach().getOfficeHour()));
